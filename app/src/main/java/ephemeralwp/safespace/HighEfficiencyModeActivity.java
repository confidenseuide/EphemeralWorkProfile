...
public class HighEfficiencyModeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("START High-Efficiency Mode? In this mode, the app will use alarms and receivers to continuously restart itself and maintain a high process priority, to make it harder for aggressive firmware to kill it and ensure its restart after death. Furthermore, when the main service restarts, not just via screen-off receiver the app will check if the screen is off or locked and wipe data. in simple words, it will check if the app has missed the screen turning off moment which occurred when the receiver was inactive and app didn't have trigger to wipe data, for example because it was killed at that moment and only then restarted.\n\n"+
