...
public class MainActivity extends Activity {
    ...
    tv.setText("Hello! This is EphemeralWorkProfile app.\n" +
            "The app creates work profile that will be destroyed when your screen turns off, phone reboots, or profile restarts, or on entering incorrect password if profile locked or on connection phone for any usb device (except ordinary charging brick).\n\n" +
