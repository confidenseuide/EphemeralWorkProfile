...
public class MainActivity extends Activity {
    ...
    tv.setText("Hello! This is EphemeralWorkProfile app.\n" +
			...
			"2. App adds \"safest\" system browser to profile (with less excessive permissions).\n" +
            ...
            "5. App selects \"safest\" system keyboard (with less excessive permissions) and freezes others.\n"+
