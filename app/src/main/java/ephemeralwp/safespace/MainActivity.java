...
public class MainActivity extends Activity {
    ...
    tv.setText("Hello! This is EphemeralWorkProfile app.\n" +
            "This app creates work profile that will be destroyed when your screen turns off, phone reboots, or profile restarts, or on entering incorrect password when profile locked, or when any USB connection is detected, except for simple charging from ordinary power brick. This includes connections to PC, other phones, Type-C headphones, and other specialized devices. This can help protect against USB-based hacker attacks.\n\n" +
