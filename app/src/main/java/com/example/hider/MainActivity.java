                    ...
                    if (seconds > 0) {            
                        ...
                        if (seconds == 8) {
							    ...
							    try {if (Build.VERSION.SDK_INT >= 30) {
									...
									b="App is added from userControlDisabled packages. This will not change your experience. As a profile owner, this app cannot be stopped from user anyway, but this option is important for the system. On some aggressive devices, the system tries to force-stop apps to save battery. We need to stay active at all times for the critical function of wiping data when the screen is off or the phone reboots. ";
